...
// required int32 num_endpoints = 1;
inline bool
telemetry_endpoint::has_num_endpoints() const
{
  return (_has_bits_[0] & 0x00000001u) != 0;
}
inline void
telemetry_endpoint::clear_num_endpoints()
{
  num_endpoints_ = 0;
...
// required int32 num_messages = 2;
inline bool
telemetry_endpoint::has_num_messages() const
{
  return (_has_bits_[0] & 0x00000002u) != 0;
}
inline void
telemetry_endpoint::clear_num_messages()
{
  num_messages_ = 0;
  _has_bits_[0] &= ~0x00000002u;
}
inline ::PROTOBUF_NAMESPACE_ID::int32
telemetry_endpoint::num_messages() const
{
...
// required int64 time_alive = 1;
inline bool
telemetry::has_time_alive() const
{
  return (_has_bits_[0] & 0x00000020u) != 0;
}
inline void
telemetry::clear_time_alive()
{
  time_alive_ = PROTOBUF_LONGLONG(0);
  _has_bits_[0] &= ~0x00000020u;
}
inline ::PROTOBUF_NAMESPACE_ID::int64
telemetry::time_alive() const
{
  // @@protoc_insertion_point(field_get:telemetry.telemetry.time_alive)
  return time_alive_;
}
inline void
telemetry::set_time_alive(::PROTOBUF_NAMESPACE_ID::int64 value)
{
  _has_bits_[0] |= 0x00000020u;
  time_alive_ = value;
...
// required string description = 2;
inline bool
telemetry::has_description() const
{
  return (_has_bits_[0] & 0x00000001u) != 0;
}
inline void
telemetry::clear_description()
{
...
telemetry::description() const
{
  // @@protoc_insertion_point(field_get:telemetry.telemetry.description)
  return description_.GetNoArena();
}
inline void
telemetry::set_description(const std::string& value)
{
  _has_bits_[0] |= 0x00000001u;
...
inline void
telemetry::set_description(std::string&& value)
{
  _has_bits_[0] |= 0x00000001u;
  description_.SetNoArena(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
...
inline void
telemetry::set_description(const char* value)
{
...
inline void
telemetry::set_description(const char* value, size_t size)
{
  _has_bits_[0] |= 0x00000001u;
  description_.SetNoArena(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
...
inline void
telemetry::set_allocated_description(std::string* description)
{
...
// required .telemetry.telemetry.endpoint publishers = 3;
inline bool
telemetry::has_publishers() const
{
  return (_has_bits_[0] & 0x00000002u) != 0;
}
inline void
telemetry::clear_publishers()
{
  if (publishers_ != nullptr)
    publishers_->Clear();
  _has_bits_[0] &= ~0x00000002u;
}
inline const ::telemetry::telemetry_endpoint&
telemetry::publishers() const
{
...
inline ::telemetry::telemetry_endpoint*
telemetry::release_publishers()
{
...
inline ::telemetry::telemetry_endpoint*
telemetry::mutable_publishers()
{
  _has_bits_[0] |= 0x00000002u;
  if (publishers_ == nullptr) {
    auto* p =
      CreateMaybeMessage<::telemetry::telemetry_endpoint>(GetArenaNoVirtual());
    publishers_ = p;
  }
...
inline void
telemetry::set_allocated_publishers(::telemetry::telemetry_endpoint* publishers)
{
...
// required .telemetry.telemetry.endpoint subscribers = 4;
inline bool
telemetry::has_subscribers() const
{
  return (_has_bits_[0] & 0x00000004u) != 0;
}
inline void
telemetry::clear_subscribers()
{
...
inline void
telemetry::set_allocated_subscribers(
...
// required .telemetry.telemetry.endpoint clients = 5;
inline bool
telemetry::has_clients() const
{
  return (_has_bits_[0] & 0x00000008u) != 0;
}
inline void
telemetry::clear_clients()
{
  if (clients_ != nullptr)
    clients_->Clear();
...
// required .telemetry.telemetry.endpoint servers = 6;
inline bool
telemetry::has_servers() const
{
  return (_has_bits_[0] & 0x00000010u) != 0;
}
inline void
telemetry::clear_servers()
{
  if (servers_ != nullptr)
    servers_->Clear();
