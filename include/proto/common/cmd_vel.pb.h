...
template<>
::movement::camera*
Arena::CreateMaybeMessage<::movement::camera>(Arena*);
template<>
::movement::drive_train*
Arena::CreateMaybeMessage<::movement::drive_train>(Arena*);
template<>
::movement::gun*
Arena::CreateMaybeMessage<::movement::gun>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace movement {
...
// required int32 linear_vel = 1;
inline bool
drive_train::has_linear_vel() const
{
  return (_has_bits_[0] & 0x00000001u) != 0;
}
inline void
drive_train::clear_linear_vel()
{
  linear_vel_ = 0;
  _has_bits_[0] &= ~0x00000001u;
}
inline ::PROTOBUF_NAMESPACE_ID::int32
drive_train::linear_vel() const
{
  // @@protoc_insertion_point(field_get:movement.drive_train.linear_vel)
  return linear_vel_;
}
inline void
drive_train::set_linear_vel(::PROTOBUF_NAMESPACE_ID::int32 value)
{
  _has_bits_[0] |= 0x00000001u;
  linear_vel_ = value;
...
// required int32 angular_vel = 2;
inline bool
drive_train::has_angular_vel() const
{
  return (_has_bits_[0] & 0x00000002u) != 0;
}
inline void
drive_train::clear_angular_vel()
{
  angular_vel_ = 0;
  _has_bits_[0] &= ~0x00000002u;
}
inline ::PROTOBUF_NAMESPACE_ID::int32
drive_train::angular_vel() const
{
  // @@protoc_insertion_point(field_get:movement.drive_train.angular_vel)
  return angular_vel_;
}
inline void
drive_train::set_angular_vel(::PROTOBUF_NAMESPACE_ID::int32 value)
{
  _has_bits_[0] |= 0x00000002u;
  angular_vel_ = value;
...
// required int32 angular_vel = 1;
inline bool
camera::has_angular_vel() const
{
  return (_has_bits_[0] & 0x00000001u) != 0;
}
inline void
camera::clear_angular_vel()
{
  angular_vel_ = 0;
  _has_bits_[0] &= ~0x00000001u;
}
inline ::PROTOBUF_NAMESPACE_ID::int32
camera::angular_vel() const
{
  // @@protoc_insertion_point(field_get:movement.camera.angular_vel)
  return angular_vel_;
}
inline void
camera::set_angular_vel(::PROTOBUF_NAMESPACE_ID::int32 value)
{
  _has_bits_[0] |= 0x00000001u;
  angular_vel_ = value;
...
inline void
gun::set_left_mag(::PROTOBUF_NAMESPACE_ID::int32 value)
{
  _has_bits_[0] |= 0x00000001u;
  left_mag_ = value;
...
inline void
gun::set_right_mag(::PROTOBUF_NAMESPACE_ID::int32 value)
{
  _has_bits_[0] |= 0x00000002u;
  right_mag_ = value;
